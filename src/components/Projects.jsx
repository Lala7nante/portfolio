...
{
  icon: '⚽',
  title: 'Site Web AS Magma',
  desc: 'Site vitrine moderne dédié au club AS Magma avec présentation du club, effectif des joueurs, actualités et calendrier des matchs.',
